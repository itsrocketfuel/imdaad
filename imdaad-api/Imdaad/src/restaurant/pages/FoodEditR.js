    ...
    render(){
        return(
            <View>
                ...
                <DatePicker onDateChange={(date)=>{this.setState({date:date})}} style = {{marginTop: 10, marginBottom: 10, marginLeft: 60, width: 300}} mode = 'date' placeholder = 'When Was Food Cooked' minDate = '1930-05-05' maxDate = '2030-05-05' format = 'YYYY-MM-DD' date = {this.state.dates} date = {this.state.date}/>
