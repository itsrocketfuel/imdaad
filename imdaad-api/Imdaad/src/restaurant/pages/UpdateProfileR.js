        ...
        updateUser = () =>{
          ...
          .then((responseJson) => {
            if(responseJson.success === true){
              this.props.navigation.navigate('updateprofiler');
      ...
      let { image } = this.state;
        return(
            <View>
                ...
                <Text style = {{paddingBottom: 30, textDecorationLine: 'underline', color: '#84c6ba', alignSelf: 'center'}} onPress = {() => this.props.navigation.navigate ('updatepasswordr')}>Update Password</Text>
